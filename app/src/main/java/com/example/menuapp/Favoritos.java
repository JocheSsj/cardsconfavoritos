...
public class Favoritos {
    ...
    // Constructor
    public Favoritos(int id, String nombre, String direccion, String tipo, String descripcion, String telefono, int favorito, String urlEstablecimiento, String logo) {
        this.id = id;
        this.nombre = nombre;
