...
public class InstitutoAdapter extends RecyclerView.Adapter<InstitutoAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.btnFavorito.setOnClickListener(v -> {
            boolean esFavorito = instituto.getFavorito() == 1;

            // Cambiar el estado de favorito en el objeto
            instituto.setFavorito(esFavorito ? 0 : 1);
            ...
            dbHelper.actualizarFavorito(instituto.getId(), instituto.getFavorito());
        });
    }
